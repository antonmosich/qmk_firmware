...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_tkl_iso(\
      ...
      RALT_T(KC_ESC), KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOT, KC_NUHS, KC_ENT, \
  ...
  [1] = LAYOUT_tkl_iso(\
      ...
      _______,_______,_______,                _______,                                DISCORD,_______,_______, _______,    BL_ON,  BL_STEP, BL_ON   )
};
