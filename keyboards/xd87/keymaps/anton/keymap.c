...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_tkl_iso(\
      ...
      _______,TABLE  ,SHRUG  ,LENNY  ,_______,_______,_______,_______,_______,_______,_______,_______,_______, _______,    KC_MNXT, KC_MPLY, KC_VOLU, \
      _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,             KC_MPRV, KC_MSTP, KC_VOLD, \
      KC_CAPS,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______, _______, \
      _______,_______,_______,_______,COMPILE,_______,KC_WSCH,_______,KC_MAIL,_______,_______,_______,         _______,             BL_TOGG, \
